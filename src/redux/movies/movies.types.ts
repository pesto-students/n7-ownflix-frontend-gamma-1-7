export const moviesActionTypes = {
    ...
    FETCH_HALFWATCHED_MOVIES_REQUEST: 'FETCH_HALFWATCHED_MOVIES_REQUEST',
    FETCH_HALFWATCHED_MOVIES_SUCCESS: 'FETCH_HALFWATCHED_MOVIES_SUCCESS',
    FETCH_HALFWATCHED_MOVIES_FAILURE: 'FETCH_HALFWATCHED_MOVIES_FAILURE',
    LOAD_MORE_HALFWATCHED_MOVIES_SUCCESS: 'LOAD_MORE_HALFWATCHED_MOVIES_SUCCESS',
}