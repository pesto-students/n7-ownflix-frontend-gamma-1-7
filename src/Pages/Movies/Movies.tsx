...
import { fetchPopularMoviesAsync, fetchLatestMoviesAsync, fetchActionMoviesAsync, fetchComedyMoviesAsync, fetchHorrorMoviesAsync, fetchThrillerMoviesAsync } from '../../redux/movies/movies.actions';
