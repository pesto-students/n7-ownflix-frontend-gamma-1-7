...
const Homepage = () => {
  ...
  const hasAddedinWatchlist =
    watchlist.movies.filter(
      (w: any) => w?.movie?._id === popularMovies.data[0]?._id
    ).length > 0;
  ...
  const handleAdd = (event: any) => {
    ...
    dispatch(
      addToWatchlistAsync(
        "/watch-list/",
        {
          entityId: popularMovies.data[0]._id,
            ...
            <>
              <div className="header">
                <div
                  className="image"
                  style={{
                    backgroundImage: `url(${popularMovies.data[0].images[0].location.cloudFrontUrl})`,
                  }}
                ></div>
                <div
                  className="image-vertical"
                  style={{
                    backgroundImage: `url(${popularMovies.data[0].imagesVertical[0].location.cloudFrontUrl})`,
                  }}
                ></div>
              </div>
              <div className="header-content">
                <img
                  src={
                    popularMovies.data[0].imagesVertical[0].location
                      .cloudFrontUrl
                  }
                  alt="poster"
                ...
                <div className="poster-details">
                  <div className="poster-details-1">
                    ...
                    <h1 className="movie-title">
                      {popularMovies.data[0].title}
                    </h1>
                    <div className="movie-details">
                      <div className="movie-details-runningTime">
                        {getFormattedDuration(popularMovies.data[0].duration)} -{" "}
                        {popularMovies.data[0].rated}
                      </div>
                      <div className="movie-details-genres">
                        {popularMovies.data[0].genres &&
                          popularMovies.data[0].genres.map((genre) => (
                            <span
                      ...
                      <div className="movie-details-rating">
                        Rating: {popularMovies.data[0].imdbRating}
                      </div>
                    </div>
                    ...
                    <div className="movie-options">
                      <Button
                        variant="contained"
                        color="primary"
                        onClick={() => onWatch(popularMovies.data[0].slug)}
                  ...
                  <div className="poster-details-2">
                    <div className="poster-images">
                      {popularMovies.data[0].images.length ? (
                        <img
                          src={
                            popularMovies.data[0].images[0].location
                              .cloudFrontUrl
                          }
                          alt="poster"
                        />
                      ) : null}
                      {popularMovies.data[0].images.length > 1 ? (
                        <img
                          src={
                            popularMovies.data[0].images[1].location
                              .cloudFrontUrl
                          }
                          alt="poster1"
                        />
                      ) : null}
                      {popularMovies.data[0].images.length > 2 ? (
                        <img
                          src={
                            popularMovies.data[0].images[2].location
                              .cloudFrontUrl
                          }
                          alt="poster1"
                        />
