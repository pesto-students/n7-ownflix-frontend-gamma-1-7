...
import {
  fetchPopularSeriesAsync,
  fetchLatestSeriesAsync,
  fetchActionSeriesAsync,
  fetchComedySeriesAsync,
  fetchHorrorSeriesAsync,
  fetchThrillerSeriesAsync,
  ...
  return (
    <div className="Series">
      ...
      <Slider
        ...
        title="Latest"
        type="series"
        sliderData={latestSeries}
      ></Slider>
      <Slider
        isLarge={true}
        title="Popular"
        type="series"
        sliderData={popularSeries}
      ></Slider>
      <Slider
        isLarge={false}
        title="Action"
        type="series"
        sliderData={actionSeries}
      ></Slider>
      <Slider
        isLarge={false}
        title="Thriller"
        type="series"
        sliderData={thrillerSeries}
      ></Slider>
      <Slider
        isLarge={false}
        title="Comedy"
        type="series"
        sliderData={comedySeries}
      ></Slider>
      <Slider
        isLarge={false}
        title="Horror"
        type="series"
        sliderData={horrorSeries}
      ></Slider>
    </div>
  );
};
